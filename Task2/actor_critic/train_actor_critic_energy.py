...
def main() -> None:
    ...
    env = make_env()
    actor = Actor(hidden_dims=args.hidden_dims, activation=args.activation)
    critic = Critic(hidden_dims=args.hidden_dims, activation=args.activation)
    target_actor = Actor(hidden_dims=args.hidden_dims, activation=args.activation)
    target_critic = Critic(hidden_dims=args.hidden_dims, activation=args.activation)
